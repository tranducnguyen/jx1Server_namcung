...
function main() 
	...
	local tbOpt = {};                                                                                              
	local szTitle = format("- Chµo mõng b¹n ®Õn víi <color=yellow>Vâ L©m TruyÒn Kú<color=yellow><enter>- <color=Red>C­u Niªn T­¬ng Phïng <color><enter>- ViÖt ho¸ tæng hîp By <color=Green>Vâ L©m TruyÒn Kú<color>");   
